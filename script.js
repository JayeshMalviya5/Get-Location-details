...
function setCurrentLocation(lat, long) {
  fetch(
    `https://api.geoapify.com/v1/geocode/reverse?lat=${lat}&lon=${long}&format=json&apiKey=9f6483015ac642558e75059cbb7aaf67`
  )
    .then((resp) => resp.json())
    .then((data) => {
      console.log(data);
...
function locationData() {
  ...
  // Replace YOUR_API_KEY with your own API key from Geoapify
  fetch(
    `https://api.geoapify.com/v1/geocode/search?text=${address}&format=json&apiKey=9f6483015ac642558e75059cbb7aaf67`
  )
